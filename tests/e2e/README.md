...
# previous node state folder. By default this is './build/.byted:/root/.byted'
...
5. After block `50` is reached,
   the test suite exports `/.byted` folder from the docker container
...
Error:  Received unexpected error:
        ...
        main.appCreator.newApp({{{0x3399b40, 0xc000ec1db8}, {0x33ac0f8, 0xc00...
            github.com/kato114/byte/v10/cmd/byted/root.go:243 +0x2ca
        ...
        main.main()
            github.com/kato114/byte/v10/cmd/byted/main.go:20 +0x45
