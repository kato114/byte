...
import (
	...
	_ "github.com/kato114/byte/v15/client/docs/statik"

	"github.com/kato114/byte/v15/app/ante"
	ethante "github.com/kato114/byte/v15/app/ante/evm"
	v10 "github.com/kato114/byte/v15/app/upgrades/v10"
	v11 "github.com/kato114/byte/v15/app/upgrades/v11"
	v12 "github.com/kato114/byte/v15/app/upgrades/v12"
	v13 "github.com/kato114/byte/v15/app/upgrades/v13"
	v14 "github.com/kato114/byte/v15/app/upgrades/v14"
	v15 "github.com/kato114/byte/v15/app/upgrades/v15"
	v16 "github.com/kato114/byte/v15/app/upgrades/v16"
	v8 "github.com/kato114/byte/v15/app/upgrades/v8"
	v81 "github.com/kato114/byte/v15/app/upgrades/v8_1"
	v82 "github.com/kato114/byte/v15/app/upgrades/v8_2"
	v9 "github.com/kato114/byte/v15/app/upgrades/v9"
	v91 "github.com/kato114/byte/v15/app/upgrades/v9_1"
	"github.com/kato114/byte/v15/encoding"
	"github.com/kato114/byte/v15/ethereum/eip712"
	"github.com/kato114/byte/v15/precompiles/common"
	srvflags "github.com/kato114/byte/v15/server/flags"
	evmostypes "github.com/kato114/byte/v15/types"
	"github.com/kato114/byte/v15/x/claims"
	claimskeeper "github.com/kato114/byte/v15/x/claims/keeper"
	claimstypes "github.com/kato114/byte/v15/x/claims/types"
	"github.com/kato114/byte/v15/x/epochs"
	epochskeeper "github.com/kato114/byte/v15/x/epochs/keeper"
	epochstypes "github.com/kato114/byte/v15/x/epochs/types"
	"github.com/kato114/byte/v15/x/erc20"
	erc20client "github.com/kato114/byte/v15/x/erc20/client"
	erc20keeper "github.com/kato114/byte/v15/x/erc20/keeper"
	erc20types "github.com/kato114/byte/v15/x/erc20/types"
	"github.com/kato114/byte/v15/x/evm"
	evmkeeper "github.com/kato114/byte/v15/x/evm/keeper"
	evmtypes "github.com/kato114/byte/v15/x/evm/types"
	"github.com/kato114/byte/v15/x/feemarket"
	feemarketkeeper "github.com/kato114/byte/v15/x/feemarket/keeper"
	feemarkettypes "github.com/kato114/byte/v15/x/feemarket/types"
	"github.com/kato114/byte/v15/x/incentives"
	incentivesclient "github.com/kato114/byte/v15/x/incentives/client"
	incentiveskeeper "github.com/kato114/byte/v15/x/incentives/keeper"
	incentivestypes "github.com/kato114/byte/v15/x/incentives/types"
	inflation "github.com/kato114/byte/v15/x/inflation/v1"
	inflationkeeper "github.com/kato114/byte/v15/x/inflation/v1/keeper"
	inflationtypes "github.com/kato114/byte/v15/x/inflation/v1/types"
	"github.com/kato114/byte/v15/x/recovery"
	recoverykeeper "github.com/kato114/byte/v15/x/recovery/keeper"
	recoverytypes "github.com/kato114/byte/v15/x/recovery/types"
	revenue "github.com/kato114/byte/v15/x/revenue/v1"
	revenuekeeper "github.com/kato114/byte/v15/x/revenue/v1/keeper"
	revenuetypes "github.com/kato114/byte/v15/x/revenue/v1/types"
	"github.com/kato114/byte/v15/x/vesting"
	vestingclient "github.com/kato114/byte/v15/x/vesting/client"
	...
	"github.com/kato114/byte/v15/x/ibc/transfer"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".byted")
