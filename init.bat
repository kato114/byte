...
byted keys add %KEY% --keyring-backend %KEYRING% --algo %KEYALGO%
...
byted add-genesis-account %KEY% 100000000000000000000000000aevmos --keyring-backend %KEYRING%

rem Sign genesis transaction
byted gentx %KEY% 1000000000000000000000aevmos --keyring-backend %KEYRING% --chain-id %CHAINID%
...
byted start --pruning=nothing %TRACE% --log_level %LOGLEVEL% --minimum-gas-prices=0.0001aevmos