...
import (
	...
	"github.com/kato114/byte/v15/server/config"
	srvflags "github.com/kato114/byte/v15/server/flags"
	"github.com/kato114/byte/v15/testutil/network"
...
Example:
	byted testnet init-files --v 4 --output-dir ./.testnets --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "byted", "Home directory of the node's daemon configuration")
...
Example:
	byted testnet --v 4 --output-dir ./.testnets
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
